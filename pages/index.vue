<template>
    <div class="w-full min-h-screen">
                ...
                <div class="flex flex-col items-start gap-4 animate-fade-in">
                    <div class="flex gap-4">
                        <NuxtLink to="https://www.linkedin.com/in/amir-talbi" target="_blank" external
                            ...
                            <Icon name="fa:linkedin" class="text-gray-300 text-lg 2xl:text-2xl" />
                        </NuxtLink>
                        ...
                        <NuxtLink to="mailto:amir.talbi@example.com"
                            class="flex gap-2 items-center justify-center min-h-10 min-w-10 2xl:min-h-14 2xl:min-w-14 rounded-full border-2 border-gray-500 hover:border-primary transition duration-300">
                            <Icon name="fa:envelope" class="text-gray-300 text-lg 2xl:text-2xl" />
                        </NuxtLink>
                        ...
                        <button
                            ...
                            <span class="uppercase font-semibold text-sm xl:text-md 2xl:text-xl text-gray-300">CV</span>
                        </button>
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        <NuxtLink to="#projects"
                            ...
                            <span class="uppercase font-semibold text-sm xl:text-md 2xl:text-xl text-gray-300">
                                mes projets
                            </span>
                            <Icon name="fa:angle-down" class="text-gray-300 text-lg 2xl:text-2xl" />
                        </NuxtLink>
                    ...
                    <UCard v-for="(skillCategory, index) in skills" :key="index"
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center gap-4 mb-6">
                                <div :class="`bg-gradient-to-r ${skillCategory.color}`"
                            ...
                            <div class="flex flex-wrap gap-2">
                                <span v-for="skill in skillCategory.skills" :key="skill"
        ...
        <!-- Footer -->
        <footer class="py-8 px-8 md:px-12 border-t border-gray-700/50 bg-gray-900/50">
            <div class="container flex flex-col md:flex-row items-center justify-between gap-6 mx-auto">
                <p class="text-gray-400 text-sm md:text-base">
                    Made with <span class="text-red-500 animate-pulse">❤️</span> by
                    <NuxtLink to="https://webinnov-paris.fr/" target="_blank" external
                            ...
                            <div class="aspect-[210/297] bg-white rounded-lg overflow-hidden relative">
                                ...
                                <div v-if="iframeError" class="absolute inset-0 flex items-center justify-center bg-white rounded-lg">
                                    <div class="text-center text-gray-600 p-4">
                                        <Icon name="fa:file-pdf-o" class="text-4xl md:text-6xl mb-2 md:mb-4 text-red-500" />
                                        <p class="text-base md:text-lg font-medium">Aperçu du CV</p>
                                        <p class="text-xs md:text-sm">amir-talbi-cv.pdf</p>
                                        <p class="text-xs mt-2 text-gray-500">Utilisez les boutons ci-dessous pour télécharger ou ouvrir le CV</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
const projects = ref([
    ...
    },
    {
        ...
        description: "Un jeu de morpion en ligne permettant de jouer contre un ami. Il propose une interface simple et intuitive, avec des graphismes modernes et une expérience utilisateur fluide.",
        image: "",
        technologies: ["Vue.js", "Tailwind CSS", "Express.js", "Socket.io", "Docker"],
    ...
    },
    {
        ...
        description: "GoMemories est une plateforme de partage de souvenirs qui permet aux utilisateurs de créer, partager et découvrir des moments mémorables.",
...
const skills = ref([
    {
        ...
        skills: ["Vue.js", "Nuxt.js", "JavaScript", "TypeScript", "HTML5", "CSS3", "Tailwind CSS"]
    },
    {
        category: "Backend",
        icon: "fa:server",
        color: "from-green-400 to-green-600",
        skills: ["Node.js", "NestJS", "Express.js", "PHP", "Symfony", "API REST", "GraphQL"]
    },
    {
        category: "DevOps",
        icon: "fa:cogs",
        color: "from-purple-400 to-purple-600",
        skills: ["Docker", "Docker Compose", "Git", "GitHub Actions", "Linux", "Nginx", "Apache"]
    },
    {
